# web/student_routes.py
from fastapi import APIRouter, Depends, HTTPException, Response
from sqlalchemy.orm import Session
from data.database import get_db
from model.student_schema import Student, StudentCreate, StudentUpdate
from service.student_validators import ValidationError, ConflictError, ResourceNotFoundError
from service.student_service import (
    list_students, get_student, create_student,
    replace_student, patch_student, remove_student,
)
